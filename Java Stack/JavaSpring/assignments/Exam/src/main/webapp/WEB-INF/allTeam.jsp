...
<p style="text-align: right; margin-right: 10px; font-size: 25px"><a href="/teams/new">Add a Team here!</a></p>
<table class="table">
    <thead>
    <tr>
        <td>
    ...
    <c:forEach var="team" items="${teams}">
        <tr class="bg-secondary">
            ...
            <td class="bg-secondary">
                ...
                <p><a style="color: black" href="/books/${Team.id}">  <c:out value="${book.title}"></c:out></a></p>
            </td>
            <td class="bg-secondary">
